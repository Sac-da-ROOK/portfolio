...
;
async function GET() {
    const publishedPosts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$posts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPosts"])().filter((post)=>post.status === 'Published').map(({ id, title, content, status, createdAt, attachments })=>({
            id,
            title,
            content,
            status,
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(publishedPosts);
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0pv8_34._.js.map